...
// From Express 5.0 onwards, wildcard * must have a name, matching the behavior of parameters. splat is just a recommended name
// Hence, to access the wild card portion, one can use req.params.splat
router.put('/api/events/*splat',authenticationCheck);
router.delete('/api/events/*splat',authenticationCheck);
